...
export default function Home() {
  ...
  return (
    <div className="min-h-screen items-center justify-center px-4 lg:px-24 mt-0 lg:mt-24 ">
      <h1 className="mb-8 text-center text-6xl dark:text-white text-black font-bold">Personal Blog Content</h1>
      {posts.map((post, idx) => (
